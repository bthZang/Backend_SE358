...
import com.penguin.esms.components.token.TokenRepository;
import com.penguin.esms.components.token.TokenType;
...
public class AuthenticationService {
    ...
    private void saveUserToken(StaffEntity user, String jwtToken) {
    ...
    private void revokeAllUserTokens(StaffEntity user) {
