...
class StaffTest {
    ...
    @Autowired
    public StaffTest(MockMvc mockMvc, ObjectMapper objectMapper) {
        this.mockMvc = mockMvc;
        this.objectMapper = objectMapper;
    }

    @Test
    @DisplayName("UTCID_Register_001")
    @Order(1)
    ...
    @Test
    @DisplayName("UTCID_Register_002")
    @Order(2)
    ...
    @Test
    @DisplayName("UTCID_Register_003")
    @Order(3)
    ...
    @Test
    @DisplayName("UTCID_Register_004")
    @Order(3)
    ...
    @Test
    @DisplayName("UTCID_Register_005")
    @Order(1)
    public void UTCID_Register_004() throws Exception {
        StaffEntity staffEntity = new StaffEntity();
        staffEntity.setName("Nguyen Hoang Hy");
        staffEntity.setPhone("00000");
        staffEntity.setPassword("123456");
    ...
    @Test
    @DisplayName("UTCID_Register_006")
    @Order(2)
    public void UTCID_Register_006() throws Exception {
        StaffEntity staffEntity = new StaffEntity();
        staffEntity.setName("Nguyen Hoang Hy");
        staffEntity.setPhone("00000");
        staffEntity.setPassword("123456");
        staffEntity.setEmail("hoanghy@gmail.com");
        staffEntity.setCitizenId("1234568");
        staffEntity.setRole(Role.ADMIN);
    ...
    @Test
    @DisplayName("UTCID_Register_007")
    @Order(3)
    public void UTCID_Register_007() throws Exception {
        AuthenticationRequest request = new AuthenticationRequest("hoanghy@gmail.com", "123456");
    ...
    @Test
    @DisplayName("UTCID_Register_008")
    @Order(3)
    public void UTCID_Register_008() throws Exception {
        AuthenticationRequest request = new AuthenticationRequest("hoanghy@gmail.com", "123746");
    ...
    @Test
    @DisplayName("UTCID_Register_009")
    @Order(2)
    public void UTCID_Register_009() throws Exception {
        StaffEntity staffEntity = new StaffEntity();
        staffEntity.setName("Nguyen Hoang Hy");
        staffEntity.setPhone("00000");
        staffEntity.setPassword("123456");
    ...
    @Test
    @DisplayName("UTCID_Register_010")
    @Order(3)
    public void UTCID_Register_010() throws Exception {
        AuthenticationRequest request = new AuthenticationRequest("hoanghy@gmail.com", "123456");
    ...
    @Test
    @DisplayName("UTCID_Register_011")
    @Order(3)
    public void UTCID_Register_011() throws Exception {
        AuthenticationRequest request = new AuthenticationRequest("hoanghy@gmail.com", "123746");
